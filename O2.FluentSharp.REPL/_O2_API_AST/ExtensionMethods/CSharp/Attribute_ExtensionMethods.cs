...
namespace FluentSharp.CSharpAST
{
    ...
    {
        public static T                 add_Attribute<T>(this T attributedNode, string attributeName) where T : AttributedNode
        {
        ...
        public static T                 add_Attribute<T>(this T attributedNode, AttributeSection attributeSection) where T : AttributedNode
        {
        ...
        public static T                 add_Attribute<T>(this T attributedNode, string attributeName, string parameterName, string parameterValue) where T : AttributedNode
        {
            var namedArgument = new NamedArgumentExpression
                {
                    Name = parameterName,
                    Expression = parameterValue.ast_Primitive()
                };
            var attribute = new Attribute {Name = attributeName};
