...
namespace FluentSharp.WinForms.Controls
{
    public partial class DirectoryViewer : UserControl
    {
        ...
        public DirectoryViewer(String sDirectoryToOpen) : this()
        {
            InitializeComponent();
        ...
        private void tvDirectory_DoubleClick(object sender, EventArgs e)
        {
            if (tvDirectory.SelectedNode != null && tvDirectory.SelectedNode.Tag != null)
            {
                ...
                if (System.IO.Directory.Exists(sSelectedNodeTag))
                {
        ...
        public bool deleteFileOrFolder(string fileOrFolderToDelete)
        {
            ...
            else if (System.IO.Directory.Exists(fileOrFolderToDelete))
                if (DialogResult.Yes ==
                    MessageBox.Show(
        ...
        private void btCreateDirectory_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                System.IO.Directory.CreateDirectory(sNewDirectoryName);
                if (System.IO.Directory.Exists(sNewDirectoryName))
                {
        ...
        private void tvDirectory_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            else   
            {
                ...
                if (sSelectedNodeTag != null)
                {
                    ...
                    deleteFolderToolStripMenuItem.Enabled = (tvDirectory.SelectedNode.Text != ".." && System.IO.Directory.Exists(sSelectedNodeTag));
        ...
        public DirectoryViewer simpleMode_withAddressBar()
        {
...
/*        private void tvDirectory_ItemDrag(object sender, ItemDragEventArgs e)
        ...
        private void tvDirectory_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (_ProcessDroppedObjects)
            {
                ...
                else if (System.IO.Directory.Exists(fileOrFolder) && fileOrFolder != getCurrentDirectory())
