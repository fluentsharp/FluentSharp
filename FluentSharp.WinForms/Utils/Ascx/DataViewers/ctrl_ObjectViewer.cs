...
{    
    ...
    public class ctrl_ObjectViewer : Control
    {
        ...
        public ctrl_ObjectViewer simpleView()
        {
            simpleView_CheckBox.@checked(true);
            return this;
        }

        public ctrl_ObjectViewer createObjectWhenNull()
        {
            createObjectWhenNull_CheckBox.@checked(true);
            return this;
        }

        public ctrl_ObjectViewer showSerializedString()
        {
            return showSerializedString(true);
        }
        public ctrl_ObjectViewer showSerializedString(bool value)
        {
